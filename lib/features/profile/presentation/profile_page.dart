          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text('设置 (Settings)', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ),
              ...
              _buildSettingsCard([
                ...
                SwitchListTile(
                  ...
                  onChanged: (val) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('深色模式开发中...')));
                  },
                  activeColor: Colors.black,
                ),
              ]),
              ...
              _buildSettingsCard([
                ...
                ListTile(
                  ...
                  onTap: () async {
                    ...
                    messenger.showSnackBar(const SnackBar(content: Text('正在初始化数据库...')));
                ...
                ListTile(
                  ...
                  onTap: () {
                     ...
                     ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Firebase 接入后可用')));
                  },
                ),
              ]),
               ...
               const Center(
                 child: Text('Version 1.0.0 (Beta)', style: TextStyle(color: Colors.grey, fontSize: 12)),
               ),
               const SizedBox(height: 40),
            ],
          ),
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            backgroundImage: const NetworkImage('https://api.dicebear.com/7.x/miniavs/png?seed=1'), // Nice placeholder
          ),
          const SizedBox(width: 20),
          const Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Product Master', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
              SizedBox(height: 4),
              Text('Level 3 · 探索者', style: TextStyle(color: Colors.grey)),
            ],
          ),
          const Spacer(),
          IconButton(
               ...
               Padding(
                 ...
                 child: Row(
                   ...
                   children: [
                     ...
                     Text('${sliderValue.toInt()} 张', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.blue)),
                   ],
                 ),
               ),
               Slider(
